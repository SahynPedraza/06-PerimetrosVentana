...
public class VentanaTrianguloEscaleno extends JFrame implements ActionListener {
	...
	/**
	 * Objeto op de la clase operaciones para calcular area de triangulo escaleno
	 */	
	...
	public void actionPerformed(ActionEvent arg0) {
		int r = op.perimetroTrianguloEscaleno(Integer.parseInt(txtN1.getText()), Integer.parseInt(txtN2.getText()), Integer.parseInt(txtN3.getText()));
		lbResultado.setText(String.format("El perimetro es: \n" + "L1 %s + \n L2 %s + L3 %s \n = %d", txtN1.getText(), txtN2.getText(), txtN3.getText(), r)); 		
	}
