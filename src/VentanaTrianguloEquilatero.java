 ...
 */	
	...
	public void actionPerformed(ActionEvent arg0) {
		int r = op.perimetroTrianguloEquilatero(Integer.parseInt(txtN1.getText()));
		lbResultado.setText(String.format("El perimetro %s = %d metros cuadrados", txtN1.getText(), r)); 		
	}
}
