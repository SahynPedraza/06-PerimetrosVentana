...
public class VentanaCuadrado extends JFrame implements ActionListener{
	...
	/**
	 * Objeto op de la clase operaciones que es llamana para calcular areas
	 */	
 ...
 */	
	...
	public void actionPerformed(ActionEvent arg0) {
		int r = op.perimetroCuadrado(Integer.parseInt(txtN1.getText()));
		lbResultado.setText(String.format("El perimetro de un cuadrado de lado %s = %d metros cuadrados", txtN1.getText(), r)); 		
	}
}
